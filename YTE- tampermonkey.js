...
// @name:ar      Youtube Tools + : All in one downloader
// @name:bg      Youtube Tools + : All in one downloader
// @name:cs      Youtube Tools + : All in one downloader
// @name:da      Youtube Tools + : All in one downloader
// @name:de      Youtube Tools + : All in one downloader
// @name:el      Youtube Tools + : All in one downloader
// @name:eo      Youtube Tools + : All in one downloader
// @name:es      Youtube Tools + : All in one downloader
// @name:fi      Youtube Tools + : All in one downloader
// @name:fr      Youtube Tools + : All in one downloader
// @name:fr-CA   Youtube Tools + : All in one downloader.
// @name:he      Youtube Tools + : All in one downloader
// @name:hu      Youtube Tools + : All in one downloader.
// @name:id      Youtube Tools + : All in one downloader
// @name:it      Youtube Tools + : All in one downloader
// @name:ko      Youtube Tools + : All in one downloader
// @name:nb      Youtube Tools + : All in one downloader
// @name:nl      Youtube Tools + : All in one downloader
// @name:pl      Youtube Tools + : All in one downloader
// @name:pt-BR   Youtube Tools + : All in one downloader
// @name:ro      Youtube Tools + : All in one downloader
// @name:ru      Youtube Tools + : All in one downloader
// @name:sk      Youtube Tools + : All in one downloader
// @name:sr      Youtube Tools + : All in one downloader
// @name:sv      Youtube Tools + : All in one downloader
// @name:th      Youtube Tools + : All in one downloader
// @name:tr      Youtube Tools + : All in one downloader
// @name:uk      Youtube Tools + : All in one downloader
// @name:ug      Youtube Tools + : All in one downloader
// @name:vi      Youtube Tools + : All in one downloader
// @description         Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:ar      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:bg      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:da      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:de      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:el      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:eo      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:fi      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:fr-CA   Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:he      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:hu      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:id      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:it      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:ko      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:nb      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:nl      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:pl      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:pt-BR   Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:ro      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:ru      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:sk      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:sr      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:sv      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:th      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:tr      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:uk      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:ug      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:vi      Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @homepage     https://github.com/TbangIT
// @version      1.7.3
// @description        Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:fr     Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:cs     Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:en     Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @description:es     Youtube Tools All in one Downloader mp4, MP3 HIGT QUALITY, auto repeat video, skip ads, return dislikes and more
// @author       T_BangIT
...
// @compatible edge
// @license MIT
// @namespace https://github.com/TbangIT
// ==/UserScript==

(function () {
  // Youtube tools by: T_bangIt,DeveloperMDCM
  // https://github.com/TbangIT/YTE-clear
  // original version: https://github.com/DeveloperMDCM/Youtube-tools-extension
   ...
   // alert('Script by: DeveloperMDCM', cat)
    ...
    setInterval(() => {
      ...
      if (addButton != undefined && validoBotones) {
          validoBotones = false;
          addButton.insertAdjacentHTML("beforebegin", newStyle);
          const mdcm = document.createElement("P");
            ...
            <div class="containerButtons">
              ...
              <button class="botones_div"  type="button"><img width="35" src="https://www.svgrepo.com/show/277433/pantone-paint.svg"><input id="color"  list="presetColors1" type="color" value="#ffffff" ></button>
              </div>
            ...
            <div id="ojosprotect" style="position: fixed; pointer-events: none; width: 100%; height: 100%; left: 0px; top: 0px; opacity: 0.2; z-index: 10; display: block;">
            </div>
            </div>
            ...
            <select class="selectcalidades  ocultarframe" required>
              <option selected disabled>Qualità del video / Quality video</option>
            ...
            <select class="selectcalidadesaudio ocultarframeaudio" required>
              <option selected disabled>Qualità dell'audio / Quality Audio</option>
          ...
          invertirVista.onclick = () => {
            ...
            // Repeat video button
              ...
              // localStorage.setItem('colorTextPage', "");
                if(document.querySelector("#cinematics > div") != undefined && videoFull != undefined){
                    //riporta il titolo youtube originale
